    ...
    <div>
      <nav className="container-menu">
        <ul className="container-menu__list">
          ...
          <li><NavLink className="menu__list--inactive" to="/userAccount">Usuario</NavLink></li>
      ...
      <label id="hamburger-menu" htmlFor="hamburger-input">
        <nav id="sidebar-menu">
          ...
          <ul className="hamburguer-menu__list">
            ...
            <li><NavLink className="hamburguer__list--inactive" to="/userAccount">Usuario</NavLink></li>
